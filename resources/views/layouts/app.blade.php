    ...
    <div class="page">
        ...
        <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <a href=".">
                    <img src="{{asset('/img/logo.png')}}" class="logo-img" alt="Tabler">
                </a>
                    ...
                    <ul class="navbar-nav pt-lg-3">
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                        <a class="dropdown-item" href="{{ Route('admin.book.create') }}">Add Data Buku</a>
                                        {{-- <a class="dropdown-item" href="{{ Route('admin.genre.create') }}">Add Genre</a> --}}
                                        <a class="dropdown-item" href="{{ Route('admin.tables') }}">Data Buku</a>
                                        <a class="dropdown-item" href="{{ Route('admin.pinjam.create') }}">Add Peminjaman Buku</a>
                                        <a class="dropdown-item" href="{{ Route('admin.pinjam.tables') }}">Peminjaman Buku</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                        <a class="dropdown-item" href="{{ Route('admin.user') }}">Data Users</a>
